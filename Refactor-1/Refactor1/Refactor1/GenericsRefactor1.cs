...
namespace Refactor1
{
    class GenericsRefactor1
    {
        ...
        public static double FloatMaximumNumber(double firstValue, double secondValue, double thirdValue)
        {
            if (firstValue.CompareTo(secondValue) >= 0 && firstValue.CompareTo(secondValue) >= 0)
            {
                return firstValue;
        ...
        public static string StringMaximumNumber(string firstValue, string secondValue, string thirdValue)
        {
            if (firstValue.CompareTo(secondValue) >= 0 && firstValue.CompareTo(secondValue) >= 0)
            {
                return firstValue;
